...
/**
 * <p>This Skeletal command allows users to interact with the configuration settings
 ...
 * file (~/.skeletal/config.groovy) take precedence over those in the JSON config.
...
"""
     ...
     * configuration settings supported by Skeletal.</p>
     * @param optionSet The command options from JOptSimple, including the
    ...
    int configList() {
        ...
        println "Valid Skeletal configuration settings:"
        println()
