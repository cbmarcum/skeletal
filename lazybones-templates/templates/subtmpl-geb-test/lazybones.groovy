...
props.cls = ask("Define value for 'class' name: [SimpleTest]", "SimpleTest", "class").capitalize()
...
FileUtils.moveFile(new File(templateDir, "Test.groovy"), destFile)

println "Created new Geb Test ${FilenameUtils.normalize(destFile.path)}"
