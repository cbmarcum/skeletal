...
[source,bash]
----
./gradlew installTemplateJavaGradle
----

== Creating a Test Project
Use the installed `java-gradle` version `0.1.0` template to create
...
[source,bash]
----
skeletal create java-gradle 0.1.0 my-java-app -Pgroup=net.codebuilders -ParchiveId=java-app -Pversion=1.0-SNAPSHOT
----
