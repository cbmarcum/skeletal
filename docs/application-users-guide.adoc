...
----
skeletal info java-gradle
----
----
Fetching package information for 'java-gradle' from repo
Name:        java-gradle
Latest:      1.1
...
More information at https://skeletal.s3.us-east-2.amazonaws.com/default-templates/java-gradle-template-1.1.zip
----
...
.create example
----
skeletal create java-gradle 1.1 my-java-app
----
...
----
skeletal create java-gradle 1.1 my-java-app -Pgroup=net.codebuilders -ParchiveId=java-app -Ppackage=net.codebuilders.app -Pversion=1.0-SNAPSHOT -PclassName=MyJavaApp
----
