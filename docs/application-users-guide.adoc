...
Grab the latest distribution from our JFrog repo using https://curl.se/download.html[curl]. Most OS's come with this installed.

.downloading with curl
[subs="verbatim,attributes"]
----
curl -o skeletal-{app-version}.zip -L https://codebuilders.jfrog.io/artifactory/generic/skeletal-app/{app-version}/skeletal-{app-version}.zip
----
